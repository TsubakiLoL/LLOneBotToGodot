...
func _ready() -> void:
	config_json_file_path=LLOneBotAPIPlugin.plugin_path+"/config/config.json"
...
func _on_installl_pressed() -> void:
	OS.shell_open(ProjectSettings.globalize_path(LLOneBotAPIPlugin.plugin_path+"/llob_install_exe/llob_install.exe"))
	pass # Replace with function body.
